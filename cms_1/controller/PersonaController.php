...
class PersonaController
{
        ...
        //Si ha pulsado el botón de acceder, tramito el formulario
            ...
            if ($persona->persona){
                ...
                if (password_verify($campo_clave,$persona->clave)) {
                    ...
                    $_SESSION["mascotas"] = $persona->mascotas;
    ...
    public function editar($id){
        ...
        if (isset($_POST["guardar"])){
            ...
            $mascotas = (filter_input(INPUT_POST, 'mascotas', FILTER_SANITIZE_STRING) == 'on') ? 1 : 0;
            ...
            if ($id == "nuevo"){
                ...
                $this->db->exec("INSERT INTO personas (persona, clave, mascotas, personas) VALUES ('$persona','$clave_encriptada',$mascotas,$personas)");
                ...
                ($cambiar_clave) ?
                    $this->db->exec("UPDATE personas SET persona='$persona',clave='$clave_encriptada',mascotas=$mascotas,personas=$personas WHERE id='$id'") :
                    $this->db->exec("UPDATE personas SET persona='$persona',mascotas=$mascotas,personas=$personas WHERE id='$id'");
