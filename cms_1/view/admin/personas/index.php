        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/personas/crear" ?>" title="Añadir nuevo administrador">
            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    <div class="card-content">
                        ...
                        <strong>Mascotas: </strong><?php echo ($row->mascotas) ? "Sí" : "No" ?>
                    </div>
                    <div class="card-action">
                ...
                <div class="card-reveal">
                    ...
                    <p>
                        ¿Está seguro de que quiere borrar al administrador<strong><?php echo $row->persona ?></strong>?<br>
