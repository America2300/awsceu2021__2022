        ...
        <div class="card horizontal admin">
            <div class="card-stacked">
                ...
                <div class="card-action">
                    <a href="<?php echo $_SESSION['home']."admin/mascotas/crear" ?>" title="Añadir nueva mascota">
            ...
            <div class="card horizontal  sticky-action admin">
                <div class="card-stacked">
                    ...
                    <div class="card-action">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/mascotas/activar/".$row->id ?>" title="<?php echo $title ?>">
                        ...
                        <a href="<?php echo $_SESSION['home']."admin/mascotas/home/".$row->id ?>" title="<?php echo $title ?>">
                ...
                <div class="card-reveal">
                    <span class="card-title grey-text text-darken-4">Borrar mascota<i class="material-icons right">close</i></span>
                    <p>
                        ¿Está seguro de que quiere borrar la mascota<strong><?php echo $row->titulo ?></strong>?<br>
                        Esta acción no se puede deshacer.
                    </p>
                    <a href="<?php echo $_SESSION['home']."admin/mascotas/borrar/".$row->id ?>" title="Borrar">
